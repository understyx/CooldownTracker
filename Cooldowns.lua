                                                                                                                                                                                                                                                    ...
                                                                                                                                                                                                                                                    if ( not registeredCD[cName] ) then return end
                                                                                                                                                                                                                                                        for spellID in pairs(registeredCD[cName]) do
                                                                                                                                                                                                                                                            ...
                                                                                                                                                                                                                                                            if ( data.tReq or data.minus ) then
                                                                                                                                                                                                                                                                ...
                                                                                                                                                                                                                                                                -- Use >= so that a stored expiry matching the current integer second is not
                                                                                                                                                                                                                                                                -- considered expired up to ~1 s too early.  Always recompute the GetTime()-
                                                                                                                                                                                                                                                                -- based deadline from the remaining Unix-timestamp seconds so the value is
                                                                                                                                                                                                                                                                -- correct after a full game restart where GetTime() resets near 0 but
                                                                                                                                                                                                                                                                -- expTimeOS remains valid.
                                                                                                                                                                                                                                                                if ( cdData.expTimeOS and cdData.expTimeOS >= time() ) then
                                                                                                                                                                                                                                                                return GetTime() + ( cdData.expTimeOS - time() )
                                                                                                                                                                                                                                                                end
                                                                                                                                                                                                                                                                return GetTime()
                                                                                                                                                                                                                                                                end
